<template>
	...
	<div id="origin_bar">
		<div class="boxwidth--1-1 padded--left padded--right">
			<a href="https://security.wikimedia.org/" class="origin_title"><img
					src="/static/Wikimedia-Foundation-logo.svg" alt="Wikimedia Foundation logo" />Wikimedia Privacy</a>
		</div>
	</div>
			...
			<header id="tool_header">
				...
				<div class="meta">
					<div class="disclaimer note">
						...
						<p>This is an experimental tool hosted on <a
								href="https://wikitech.wikimedia.org/wiki/Portal:Toolforge"
								target="_blank">Toolforge</a>. No additional personal data is collected by this tool per
							the Cloud
					...
					<div class="description padded--right">
						<p>This tool, built at the 2024 Wikimedia Hackathon by <a
								href="https://meta.wikimedia.org/wiki/User:HTriedman_(WMF)" target="_blank">Hal
								Triedman</a> and <a href="https://meta.wikimedia.org/wiki/User:MGerlach_(WMF)"
								target="_blank">Martin Gerlach</a>, provides
						...
						<p>The source datasets for this tool has been made safer for readers using <a
								href="https://en.wikipedia.org/wiki/Differential_privacy" target="_blank">differential
								privacy</a>, and
						...
						<p>The source code for this tool is available (<a
								href="https://github.com/htried/dp-pageviews-tool-ui" target="_blank">frontend</a>, <a
								href="https://gitlab.wikimedia.org/htriedman/dp-pageviews-tool-backend"
								target="_blank">backend</a>) for
							use under the MIT License on Github and on the Wikimedia Foundation Gitlab instance,
							respectively.</p>
					</div>
				</div>
			</header>
			...
			<section class="boxwidth--1-1 padded--left padded--right">
				...
				<section class="text">
					...
					<ol>
						...
						<li>Hit the "Graph Data!" button to see a line graph of the data or the "Map Data!" button to
							see an
							interactive map of the data.</li>
						<li>You can filter the line graph to a selection of countries at the bottom of this page.</li>
					</ol>
					<p>On the map, countries that are dark grey do not have data published about them, in line with
						WMF's <a
							href="https://foundation.wikimedia.org/wiki/Legal:Country_and_Territory_Protection_List"
							target="_blank">Country and Territory Protection List</a> policy. Note that, prior to the
						policy update in
						early 2024, many more countries were not published.</p>
				</section>
			</section>
			<div class="separator"></div>
			<div id="app" class="boxwidth--1-1 padded--left padded--right">
				<PageSearch @graphData="onGraphSelect" @mapData="onMapSelect" />
				<LineGraph v-if="showGraph" :project="project" :pageID="pageID" :startDate="startDate"
					:endDate="endDate" />
				<TopoJsonMap v-if="showMap" :project="project" :pageID="pageID" :startDate="startDate"
					:endDate="endDate" />
			</div>
		</main>
	</article>
	<footer id="tool_footer">
		<div id="tool_footer-in" class="boxwidth--1-1 padded--left padded--right">
			<p>Experimental tool developed by <span class="tool-author"><a href="https://haltriedman.com"
						target="_blank">Hal
						Triedman</a></span> as part of the <a href="https://security.wikimedia.org/" target="_blank">WMF
					Privacy
					Engineering</a> team and <a href="https://meta.wikimedia.org/wiki/User:MGerlach_(WMF)"
					target="_blank">Martin
					Gerlach</a> as part of the <a href="https://research.wikimedia.org" target="_blank">Research
					team</a>.</p>
			<ul>
